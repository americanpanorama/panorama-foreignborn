...
ForeignBornCopy.years['1950'] = "In 1950, the foreign born dropped both as a percentage of the total population and as an absolute value.";
ForeignBornCopy.years['1960'] = "In 1960, as the percentage of foreign born continued to decline, some very modest liberalization of immigration policy took effect as Congress passed an immigration act that, for the first time, omitted racial distinctions. At the same time it barred communists and other subversives from entering the US.";
